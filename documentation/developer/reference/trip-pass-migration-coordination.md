...
milestone. The latest applied migration is `0012_terminal_account_closure.sql`; do not edit
`drizzle/0000_initial_schema.sql` through `drizzle/0012_terminal_account_closure.sql`.
