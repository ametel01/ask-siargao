...
| `/api/stripe/webhook` | `POST` | Retained legacy Stripe evidence route; it cannot authorize new Trip Pass access | Legacy webhook secret; no Lemon Squeezy fallback |
