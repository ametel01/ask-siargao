/* eslint-disable */
export type Token = `aspectRatios.${AspectRatioToken}` | `borders.${BorderToken}` | `fontWeights.${FontWeightToken}` | `lineHeights.${LineHeightToken}` | `letterSpacings.${LetterSpacingToken}` | `blurs.${BlurToken}` | `sizes.${SizeToken}` | `animations.${AnimationToken}` | `colors.${ColorToken}` | `gradients.${GradientToken}` | `fonts.${FontToken}` | `fontSizes.${FontSizeToken}` | `radii.${RadiusToken}` | `shadows.${ShadowToken}` | `spacing.${SpacingToken}` | `easings.${EasingToken}` | `durations.${DurationToken}` | `breakpoints.${BreakpointToken}`

export type ColorPalette = "current" | "black" | "white" | "transparent" | "rose" | "pink" | "fuchsia" | "purple" | "indigo" | "blue" | "sky" | "cyan" | "teal" | "emerald" | "green" | "lime" | "yellow" | "amber" | "orange" | "red" | "neutral" | "stone" | "zinc" | "gray" | "slate" | "navy" | "violet" | "lavender" | "sunset" | "confidence" | "surface" | "text" | "risk" | "border" | "shadow"
