const tokens = {
  ...
  "colors.navy.800": {
    "value": "#20186b",
    "variable": "var(--colors-navy-800)"
  },
  "colors.navy.850": {
    "value": "#17105a",
    "variable": "var(--colors-navy-850)"
  },
  "colors.navy.900": {
    "value": "#10124a",
    "variable": "var(--colors-navy-900)"
  },
  "colors.navy.950": {
    "value": "#090d3a",
    "variable": "var(--colors-navy-950)"
  },
  "colors.navy.980": {
    "value": "#05082a",
    "variable": "var(--colors-navy-980)"
  },
  "colors.violet.50": {
    "value": "#f5f3ff",
  ...
  "colors.violet.550": {
    "value": "#7a51f0",
    "variable": "var(--colors-violet-550)"
  },
  "colors.violet.600": {
    "value": "#6c46e8",
  ...
  "colors.violet.650": {
    "value": "#5d3ed1",
    "variable": "var(--colors-violet-650)"
  },
  "colors.violet.700": {
    "value": "#4c31b8",
  ...
  "colors.lavender.100": {
    "value": "#f5f3ff",
    "variable": "var(--colors-lavender-100)"
  },
  "colors.lavender.150": {
    "value": "#eeeafd",
    "variable": "var(--colors-lavender-150)"
  },
  "colors.lavender.200": {
    "value": "#e2dcf7",
    "variable": "var(--colors-lavender-200)"
  },
  "colors.lavender.300": {
    "value": "#cbc3ec",
    "variable": "var(--colors-lavender-300)"
  },
  "colors.lavender.400": {
    "value": "#b8a6ff",
    "variable": "var(--colors-lavender-400)"
  },
  "colors.sunset.coral": {
    "value": "#ff9b83",
    "variable": "var(--colors-sunset-coral)"
  },
  "colors.sunset.peach": {
    "value": "#ffc69a",
    "variable": "var(--colors-sunset-peach)"
  },
  "colors.sunset.gold": {
    "value": "#ffd65a",
    "variable": "var(--colors-sunset-gold)"
  },
  "colors.confidence.high": {
    "value": "#1e9f63",
    "variable": "var(--colors-confidence-high)"
  },
  "colors.confidence.highSoft": {
    "value": "#e6f8ee",
    "variable": "var(--colors-confidence-high-soft)"
  },
  "colors.confidence.medium": {
    "value": "#d99b23",
    "variable": "var(--colors-confidence-medium)"
  },
  "colors.confidence.mediumSoft": {
    "value": "#fff4cf",
    "variable": "var(--colors-confidence-medium-soft)"
  },
  "colors.surface": {
    "value": "#ffffff",
  ...
  "colors.surface.soft": {
    "value": "#fbfaff",
    "variable": "var(--colors-surface-soft)"
  },
  "colors.surface.tint": {
    "value": "#f7f5ff",
  ...
  "colors.surface.glass": {
    ...
    "variable": "var(--colors-surface-glass)"
  },
  "colors.surface.darkGlass": {
    "value": "rgba(9, 13, 58, 0.72)",
    "variable": "var(--colors-surface-dark-glass)"
  },
  "colors.text.strong": {
    "value": "#0d104a",
    "variable": "var(--colors-text-strong)"
  },
  "colors.text": {
    "value": "#17184f",
  ...
  "colors.text.soft": {
    "value": "#8483a8",
    "variable": "var(--colors-text-soft)"
  },
  "colors.text.onDark": {
    "value": "#ffffff",
    "variable": "var(--colors-text-on-dark)"
  },
  "colors.text.onDarkMuted": {
    "value": "#d8d5f4",
    "variable": "var(--colors-text-on-dark-muted)"
  },
  "colors.risk.low": {
    "value": "#60aa60",
    "variable": "var(--colors-risk-low)"
  },
  "colors.risk.lowDark": {
    "value": "#2e8a38",
    "variable": "var(--colors-risk-low-dark)"
  },
  "colors.risk.medium": {
    "value": "#e6a928",
    "variable": "var(--colors-risk-medium)"
  },
  "colors.risk.high": {
    "value": "#d84b55",
    "variable": "var(--colors-risk-high)"
  },
  "colors.border": {
    "value": "#ddd8ef",
  ...
  "colors.border.onDark": {
    ...
    "variable": "var(--colors-border-on-dark)"
  },
  "colors.shadow": {
    "value": "rgba(14, 12, 56, 0.16)",
    "variable": "var(--colors-shadow)"
  },
  "colors.shadow.strong": {
    "value": "rgba(8, 8, 38, 0.32)",
    "variable": "var(--colors-shadow-strong)"
  },
  "gradients.heroOverlay": {
    "value": "linear-gradient(90deg, rgba(5, 8, 42, 0.96) 0%, rgba(16, 18, 74, 0.72) 46%, rgba(93, 62, 209, 0.22) 100%)",
    "variable": "var(--gradients-hero-overlay)"
  },
  "gradients.coastalOverlay": {
    "value": "linear-gradient(90deg, rgba(5, 8, 42, 0.94) 0%, rgba(9, 13, 58, 0.76) 48%, rgba(76, 49, 184, 0.34) 100%)",
  ...
  "gradients.priceCard": {
    ...
    "variable": "var(--gradients-price-card)"
  },
  "gradients.panel": {
    "value": "linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 246, 255, 0.96) 100%)",
    "variable": "var(--gradients-panel)"
  },
  "fonts.serif": {
  ...
  "shadows.card": {
    "value": "0 14px 36px rgba(14, 12, 56, 0.12)",
    "variable": "var(--shadows-card)"
  },
  "shadows.panel": {
    "value": "0 18px 48px rgba(14, 12, 56, 0.16)",
    "variable": "var(--shadows-panel)"
  },
  "shadows.strong": {
    "value": "0 22px 54px rgba(8, 8, 38, 0.28)",
  ...
  "shadows.violetGlow": {
    "value": "0 18px 46px rgba(124, 81, 240, 0.38)",
    "variable": "var(--shadows-violet-glow)"
  },
  "shadows.coastalFrame": {
    "value": "0 24px 80px rgba(0, 0, 0, 0.42)",
    "variable": "var(--shadows-coastal-frame)"
  },
  "spacing.0": {
    "value": "0rem",
  ...
  "colors.colorPalette.980": {
    "value": "var(--colors-color-palette-980)",
    "variable": "var(--colors-color-palette-980)"
  },
  "colors.colorPalette.550": {
    "value": "var(--colors-color-palette-550)",
    "variable": "var(--colors-color-palette-550)"
  },
  "colors.colorPalette.650": {
    "value": "var(--colors-color-palette-650)",
    "variable": "var(--colors-color-palette-650)"
  },
  ...
  "colors.colorPalette.highSoft": {
    "value": "var(--colors-color-palette-high-soft)",
    "variable": "var(--colors-color-palette-high-soft)"
  },
  "colors.colorPalette.medium": {
    "value": "var(--colors-color-palette-medium)",
    "variable": "var(--colors-color-palette-medium)"
  },
  "colors.colorPalette.mediumSoft": {
    "value": "var(--colors-color-palette-medium-soft)",
    "variable": "var(--colors-color-palette-medium-soft)"
  },
  "colors.colorPalette.soft": {
    "value": "var(--colors-color-palette-soft)",
    "variable": "var(--colors-color-palette-soft)"
  },
  "colors.colorPalette.tint": {
    "value": "var(--colors-color-palette-tint)",
    "variable": "var(--colors-color-palette-tint)"
  },
  "colors.colorPalette.glass": {
    "value": "var(--colors-color-palette-glass)",
    "variable": "var(--colors-color-palette-glass)"
  },
  "colors.colorPalette.darkGlass": {
    "value": "var(--colors-color-palette-dark-glass)",
    "variable": "var(--colors-color-palette-dark-glass)"
  },
  ...
  "colors.colorPalette.onDark": {
    "value": "var(--colors-color-palette-on-dark)",
    "variable": "var(--colors-color-palette-on-dark)"
  },
  "colors.colorPalette.onDarkMuted": {
    "value": "var(--colors-color-palette-on-dark-muted)",
    "variable": "var(--colors-color-palette-on-dark-muted)"
  },
  "colors.colorPalette.low": {
    "value": "var(--colors-color-palette-low)",
    "variable": "var(--colors-color-palette-low)"
  },
  "colors.colorPalette.lowDark": {
    "value": "var(--colors-color-palette-low-dark)",
    "variable": "var(--colors-color-palette-low-dark)"
  }
}
