...
- [Thin Agent Harness Implementation Spec](developer/reference/thin-agent-harness-spec.md): implementation background for Codex-style memory loading and model-selected chat artifacts.
