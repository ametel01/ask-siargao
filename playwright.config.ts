...
const baseServerEnv =
  "ADMIN_ACCESS_TOKEN= CLERK_AUTH_MODE=disabled NEXT_PUBLIC_CLERK_AUTH_MODE=disabled CLERK_DEPLOYMENT_CONTEXT=local NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY= CLERK_SECRET_KEY= DATABASE_URL= REDIS_URL= NEXT_PUBLIC_MODEL_PROVIDER_CONSENT_REQUIRED=true";
