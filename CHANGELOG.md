...
- Added deterministic research intent and required-evidence planning for current recommendations,
  schedules, availability, prices, safety/disruption, and current comparison prompts.
