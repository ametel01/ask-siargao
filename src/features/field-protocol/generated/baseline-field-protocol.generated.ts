...
export const baselineFieldProtocolPackageData = {
  ...
  manifest: {
    ...
    files: [
      {
        ...
        sha256: "207d1e1bebe6ed182837ac8de2c3b92858fb0191b9cf5b68d1659356e83ef659",
      },
      {
    ...
    signature: {
      algorithm: "Ed25519",
      value:
        "DSCUtiUr7DSmnkr8NtzU7ksAsgXKKHjknYKSg6uRbk0SB77PCLOrybKdV2T3FlaLthRRwdy3aZG5EuKeDyIODw==",
    },
  },
} as const;
  ...
  signers: [
    {
      ...
      algorithm: "Ed25519",
      publicKeySpkiBase64: "MCowBQYDK2VwAyEAeCAlebuZtPSQ1yHHGH79SdqYaPOnZMlO6dcqb1XrZsU=",
      status: "trusted",
    },
  ],
} as const;
