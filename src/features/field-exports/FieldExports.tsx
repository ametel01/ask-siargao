...
function ProductionExports() {
  ...
  return (
    <main className="min-h-screen bg-[#f5eddc] px-4 py-8 text-[#0d104a] sm:px-6" id="main-content">
      <a className="sr-only focus:not-sr-only" href="#export-workflows">
...
function HarnessExports() {
  ...
  return (
    <main className="min-h-screen bg-[#f5eddc] p-8 text-[#0d104a]" id="main-content">
      <section className="mx-auto max-w-3xl rounded-xl bg-[#fffdf7] p-8">
        ...
        <button
          ...
          onClick={() => setStatus("Created from protected fixture · transfer receipt pending")}
          type="button"
        >
          Create Recovery Export
        </button>
        <button
          className="ml-2 rounded bg-[#5d3ed1] px-4 py-3 font-bold text-white"
          onClick={() => setStatus("Created reviewed Field Batch · transfer receipt pending")}
          type="button"
        >
          Create reviewed Field Batch
        </button>
